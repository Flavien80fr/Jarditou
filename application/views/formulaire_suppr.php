  ...
  <div class="container">
  	...
  	<div class="row">
  		<div class="col-12">
            ...
            ?>
            <hr>
            <form action="<?= site_url("jardiland/formulaire_suppr") ?>" method="post">
                ...
                <onclick="return confirm(Etes vous sure de votre choix)">Envoyer></button>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item"><a class="nav-link"
              <a href="<?php echo site_url("jardiland/formulaire_modif/".$formulaire_visu->pro_id); ?>">
                  UPDATE
              </a></li>
              <li class="nav-item active"><a class="nav-link"
              <a href="<?php echo site_url("jardiland/formulaire_suppr/".$formulaire_visu->pro_id); ?>">
                  DELETE </a></li>
              <li class="nav-item"><a class="nav-link"
